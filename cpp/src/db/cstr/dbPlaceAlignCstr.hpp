...
#include "db/dbRegion.hpp"
#include "db/cstr/dbPlaceArrayCstr.hpp"
...
public:
  PlaceAlignCstr()
    : _idx(-1), _isHor(false), _isHigh(false)
  {}
  ~PlaceAlignCstr() {}
  ...
  bool                            isHor()                                 const { return _isHor; }
  bool                            isVer()                                 const { return !_isHor; }

  bool                            isHigh()                                const { return _isHigh; }
  bool                            isLow()                                 const { return !_isHigh; }
...
private:
  ...
  Vector<PlaceArrayCstr*> _vpArrays;
  bool                    _isHor;
  bool                    _isHigh;
};
