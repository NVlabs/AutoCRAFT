...
class AcRoutePathMatchGroupHierCallbacks(DefaultCallbacks):
    ...
    def on_episode_end(self,
        ...
        # print('total steps:', env.env_steps)
        # print('total top-level steps:', env.env_top_level_steps)
        # print('total mid-level steps:', env.env_mid_level_steps)
        # print('total low-level steps:', env.env_low_level_steps)
