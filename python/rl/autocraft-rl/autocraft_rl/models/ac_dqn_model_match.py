...
class AcRouteDQNMatchModel(DQNTorchModel):
    def __init__(self,
        ...
        super(AcRouteDQNMatchModel, self).__init__(obs_space, action_space, num_outputs, model_config, name, **customized_model_kwargs)
    ...
    def forward(self,
        ...
        return (h, avg, target_wl, target_via, action_mask), state
    ...
    def get_q_value_distributions(self, model_out):
        ...
        h = model_out[0]
        avg = model_out[1]
        target_wl = model_out[2]
        target_via = model_out[3]
    ...
    def get_state_value(self, model_out):
        ...
        target_wl = th.squeeze(model_out[2], 1)
        target_via = th.squeeze(model_out[3], 1)
        y = th.cat((avg, target_wl, target_via), dim=-1)
        return self.value_module(y)
